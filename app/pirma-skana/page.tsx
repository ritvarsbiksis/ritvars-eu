      ...
      <div className="flex gap-12 flex-wrap ">
        ...
        <div style={{ maxWidth: 600 }} className="min-w-44">
          ...
          <div className="text-xl font-light flex-col mt-10 flex gap-6">
            <p>
              “Pirmās skaņas” mehānika ir balstīta uz klasisko vienādo attēlu
              savienošanas spēli, bet attēlu vietā ir jāmeklē vienādās skaņas
              (pirmos burtus) ar kādām objekts tiek izteikts. Šādā veidā bērnam
              tiek trenēta atmiņa, priekšstats par saikni starp dažādām lietām,
              lasīšana. Aplikācija ir veidota izmantojot gan objektus, kurus
              bērni spēj atpazīt, gan svešākus, ar ko bērni var sastapties,
              tādējādi motivējot iemācīties jaunas lietas un mudinot sadarbību
              ar vecākiem vai brāļiem un māsām.
            </p>
            <p>
              Aplikācijas mērķis ir piedāvāt drošu, iedvesmojošu un
              pilnveidojošu digitālo vidi, kur bērns var attīstīt dažādu objektu
              atpazīšanu, izrunu un iztēli. Mēs ticam, ka katrā bērnā ir
              pētnieka gars, un mūsu aplikācija ir veidota tā, lai palīdzētu šo
              potenciālu attīstīt.
            </p>
